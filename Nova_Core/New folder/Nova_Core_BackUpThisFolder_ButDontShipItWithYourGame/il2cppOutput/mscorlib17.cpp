...
IL_0086:
	...
	}
	{
		...
		NullCheck(L_27);
		bool L_30 = VirtFuncInvoker1< bool, Type_t * >::Invoke(110 /* System.Boolean System.Type::IsSubclassOf(System.Type) */, L_27, L_29);
		if (L_30)
		{
			goto IL_00b2;
		}
...
IL_007a:
	...
	}
	{
		...
		NullCheck(L_35);
		Type_t * L_36 = VirtFuncInvoker0< Type_t * >::Invoke(102 /* System.Type System.Type::GetGenericTypeDefinition() */, L_35);
